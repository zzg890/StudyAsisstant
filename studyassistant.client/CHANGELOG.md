...
- Create Angular project with ng: `ng new studyassistant.client --defaults --skip-install --skip-git --no-standalone `.
...
- Create project file (`studyassistant.client.esproj`).
